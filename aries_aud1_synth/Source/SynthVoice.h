...
//#include "../../maximillion/maximilian.h"	//I cannot currently get maximilian to work on windows. :( so I'm commenting the references out. I will continue work on this - Victoria


/**********************************************************************************
** This class can be used as a template for the other synth voices.
** -Victoria
***********************************************************************************/
