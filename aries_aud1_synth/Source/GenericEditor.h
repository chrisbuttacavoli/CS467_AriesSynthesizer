...
public:
	...
	void resized() override
	{
		...
		//Lo pass filter
		paramLabels[12]->setBounds(455, 225, (r.getWidth() / 4.8), 25);
		paramSliders[12]->setBounds(455, 225, (r.getWidth() / 4.8), 50);

		//Hi pass filter
		paramLabels[13]->setBounds(455, 265, (r.getWidth() / 4.8), 25);
		paramSliders[13]->setBounds(455, 265, (r.getWidth() / 4.8), 50);
